...
```toml
[dependencies]
my_country = { version = "0.1.8", default-features = false, features = ["us", "alpha2", "iso_short_name", "currency_code"] }
```
...
// my_country = { version = "0.1.8", default-features = false, features = ["us", "name", "currency_code", "alpha3"] }
```
...
// Code generation with feature flags
// my_country = { version = "0.1.8", default-features = false, features = ["us", "region", "g7_member", "country_code", "national_number_lengths"] }
```
...
// Code generation with feature flags
// my_country = { version = "0.1.8", default-features = false, features = ["us", "currency_name", "currency_numeric_code", "currency_minor_unit", "currency_code"] }
```
...
// Code generation with feature flags
// my_country = { version = "0.1.8", default-features = false, features = ["us", "subdivision_name", "locale_en", "subdivision_geo"] }
```
...
// Code generation with feature flags
// my_country = { version = "0.1.8", default-features = false, features = ["us", "alpha2", "alpha3", "numeric_code", "iso_short_name", "iso_long_name", "continent", "region", "subregion", "geo", "country_code", "international_prefix", "postal_code_format", "emoji_flag"] }
```
...
// Code generation with feature flags
// my_country = { version = "0.1.8", default-features = false, features = ["currency_code_usd", "currency_numeric_code", "currency_minor_unit"] }
```
...
// Code generation with feature flags
// my_country = { version = "0.1.8", default-features = false, features = ["us", subdivision_name", "subdivision_code", "subdivision_geo", "subdivision_comments", "locale_fa"] }
```
...
// my_country = { version = "0.1.8", default-features = false, features = ["locale_fa", "locale_es"] }
```
...
```toml
[dependencies]
my_country = { version = "0.1.8", default-features = false, features = ["us", "alpha2", "currency_code", "iso_short_name"] }
```
...
```toml
[dependencies]
my_country = { version = "0.1.8", default-features = false, features = ["us", "ca", "mx"] }
```
